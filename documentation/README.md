...
4. Close with [11-packaging-distribution.md](11-packaging-distribution.md), [12-error-handling-reporting.md](12-error-handling-reporting.md), [13-implementation-plan.md](13-implementation-plan.md), [14-three-products-rag-strategy.md](14-three-products-rag-strategy.md), [15-end-to-end-verification.md](15-end-to-end-verification.md), [16-end-to-end-testing-guide.md](16-end-to-end-testing-guide.md), [17-windows-distribution-release-checklist.md](17-windows-distribution-release-checklist.md), [18-installer-code-signing-publishing.md](18-installer-code-signing-publishing.md), [19-automatic-update-channel.md](19-automatic-update-channel.md), [20-manual-windows-app-e2e-handover.md](20-manual-windows-app-e2e-handover.md), [21-admin-license-payment-boundary.md](21-admin-license-payment-boundary.md), [22-managed-cloud-backup-boundary.md](22-managed-cloud-backup-boundary.md), [23-wakili-mkononi-integration-boundary.md](23-wakili-mkononi-integration-boundary.md), [24-hosted-ai-llm-boundary.md](24-hosted-ai-llm-boundary.md), [25-jurisnuru-firm-management.md](25-jurisnuru-firm-management.md), [25-jurisnuru-gap-analysis.md](25-jurisnuru-gap-analysis.md), [26-jurisnuru-seats-networking.md](26-jurisnuru-seats-networking.md), [27-jurisnuru-signing-key-decision.md](27-jurisnuru-signing-key-decision.md), [28-license-issuance-runbook.md](28-license-issuance-runbook.md), [29-jurisnuru-llm-free-guarantee.md](29-jurisnuru-llm-free-guarantee.md), [30-jurisnuru-android-companion.md](30-jurisnuru-android-companion.md), and [doc-extraction-improvement.md](doc-extraction-improvement.md).
...
| [21-admin-license-payment-boundary.md](21-admin-license-payment-boundary.md) | Admin, license sync, payment entitlement, and local recovery boundary |
| [22-managed-cloud-backup-boundary.md](22-managed-cloud-backup-boundary.md) | AWS/Azure/GCP encrypted cloud backup grants, upload safety, and restore drill |
| [23-wakili-mkononi-integration-boundary.md](23-wakili-mkononi-integration-boundary.md) | User-approved Wakili-Mkononi matter and citation handoff boundary |
| [24-hosted-ai-llm-boundary.md](24-hosted-ai-llm-boundary.md) | Hosted AI prompt, provider, citation, fallback, and audit boundary |
| [25-jurisnuru-firm-management.md](25-jurisnuru-firm-management.md) | JurisNuru multi-seat firm management, matter workspace, calendar, roles, and backend boundary |
| [25-jurisnuru-gap-analysis.md](25-jurisnuru-gap-analysis.md) | Brief vs e-filing portal vs shipped reality, per feature, with confirmed defects |
| [26-jurisnuru-seats-networking.md](26-jurisnuru-seats-networking.md) | Solo and firm operating modes, seat semantics, LAN serving and bind policy, transport security, and the provisioned-user caveat |
| [30-jurisnuru-android-companion.md](30-jurisnuru-android-companion.md) | Specification for the out-of-office Android companion: sync-on-office-Wi-Fi, pairing, screens, and what is deliberately excluded |
| [29-jurisnuru-llm-free-guarantee.md](29-jurisnuru-llm-free-guarantee.md) | Why no LLM subscription is required, how that is enforced in CI, and the retrieval-quality trade-off it costs |
| [27-jurisnuru-signing-key-decision.md](27-jurisnuru-signing-key-decision.md) | Open decision on the license signing keypair, custody requirements, and the checks now guarding it |
| [28-license-issuance-runbook.md](28-license-issuance-runbook.md) | How the vendor issues, verifies, sends and rotates a licence, and what is not automated |
| [doc-extraction-improvement.md](doc-extraction-improvement.md) | Extraction and OCR accuracy: current defects, what transfers from a production VLM pipeline, and a staged plan |
